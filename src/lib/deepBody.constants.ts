...
export const DEEP_BODY_TECHNIQUES: DeepBodyTechnique[] = [
  ...
  },
  {
    id: 'herbalCompress',
    name: {
      vi: 'Chườm Thảo Dược Cổ Truyền Giải Độc',
      en: 'Ancient Herbal Detox Compress',
      cn: '古法草本草药包通络解毒',
      jp: '伝統ハーブボール温熱デトックス',
      kr: '전통 허브볼 온열 디톡스 테라피',
    },
    shortDesc: {
      vi: 'Túi chườm hấp chín từ 18 vị thảo mộc thiên nhiên (gừng núi, nghệ cứu, sả chanh, ngải cứu) thẩm thấu qua da.',
      en: 'Steamed herbal pouches packed with 18 medicinal roots and leaves to reduce inflammation and boost immunity.',
      cn: '精选18味天然珍贵草本（老姜、艾草、柠檬草等）蒸热敷贴，草本精华深层渗透。',
      jp: 'ショウガ、ヨモギ、レモングラスなど18種の蒸しハーブボールでポンポンと圧をかけ、血行と代謝を促進。',
      kr: '18가지 천연 한방 약재를 증기로 쪄내어 피부 깊숙이 약효를 흡수시키고 염증과 부기를 완화합니다.',
    },
    fullDesc: {
      vi: 'Phương thức ngâm cứu và ấn túi thảo dược nóng trên các đường kinh mạch chính. Tinh dầu thảo mộc bốc hơi ấm giúp giảm viêm sưng, tan máu bầm, hỗ trợ đào thải độc tố và mang lại mùi hương đồng nội an thần.',
      en: 'Rhythmic patting and pressing of steaming herbal compresses over meridian paths relieves systemic aches and invigorates Chi flow.',
      cn: '将热气腾腾的草药球有节奏地按压于各主要穴位，草药精油透过毛孔渗入肌肤，消肿止痛，唤醒生机。',
      jp: '温かいハーブのエキスと香りが全身を包み込み、筋肉痛を和らげ、心身の緊張を優しく解き放ちます。',
      kr: '따스한 약초 주머니를 림프절과 경혈에 지그시 눌러주어 부종을 가라앉히고 자연 치유력을 높여줍니다.',
    },
    badge: {
      vi: 'Giải Độc & Dịu Đau',
      en: 'Herbal Detox',
    ...
    thumbnail: '/assets/images/treatments/herbal-thumb.jpg',
    techniqueGallery: [
      '/assets/images/treatments/herbal-1.jpg',
      '/assets/images/treatments/herbal-2.jpg',
    ],
    intensity: 3,
    recommendedFor: {
      vi: 'Viêm cơ ê ẩm, người mệt mỏi suy nhược, phụ nữ cần phục hồi năng lượng',
      en: 'Muscle inflammation, post-illness fatigue, wellness restoration',
      cn: '肌肉酸痛发炎、气血两虚、产后或病后调理体质者',
      jp: '筋肉の炎症・だるさ、慢性疲労、産後や更年期のケアに',
      kr: '근육 뻐근함, 기력 저하, 디톡스 및 힐링이 필요한 여성 고객',
    },
  },
  {
    id: 'bambooDeepRelief',
    name: {
      vi: 'Trị Liệu Thanh Tre Ấm Chuyên Sâu',
      en: 'Warm Bamboo Deep Tension Release',
      cn: '温润热竹深层肌肉舒缓',
      jp: '温熱バンブー（竹）ディープトリートメント',
      kr: '웜 뱀부(대나무) 심층 이완 테라피',
    },
    shortDesc: {
      vi: 'Sử dụng các thanh tre tự nhiên giữ nhiệt lăn ép sâu dọc theo cột sống và bắp đùi, miết tan cục xơ cơ.',
      en: 'Smooth heated bamboo stalks rolled firmly along major muscle chains to melt stubborn tightness quickly.',
      cn: '利用特制天然温热竹筒贴合肌理滚动施压，强力熨平深层肌筋膜结节。',
      jp: '温めた天然の竹を転がしながら、広背筋や太ももなど大きな筋肉の深部までしっかり圧を届けます。',
      kr: '따뜻하게 데운 천연 대나무 봉을 굴려 큰 근육의 긴장을 부드럽고 강력하게 풀어줍니다.',
    },
    fullDesc: {
      vi: 'Thanh tre với tiết diện tròn giúp phân tán lực đều nhưng có thể đi sâu hơn bàn tay thông thường gấp nhiều lần. Cực kỳ hữu hiệu với các vùng cơ lớn như cơ lưng rộng, mông đùi và bắp chân.',
      en: 'The cylindrical contour of heated bamboo delivers consistent, deep rolling pressure that hands alone cannot achieve, ideal for large muscle groups.',
      cn: '圆柱形竹筒受力均匀且渗透力强，能深入徒手难以触及的坚硬肌肉层，尤其适合背阔肌与腿部。',
      jp: '手のひらでは届きにくい大きな筋肉群を竹のローラー効果で均一に深揉み。驚くほどの軽快感を実現。',
      kr: '원통형 대나무의 밀착 롤링 압박으로 뭉친 대근육군을 빈틈없이 이완시켜 놀라운 개운함을 선사합니다.',
    },
    badge: {
      vi: 'Đặc Trị Cơ Lớn',
      en: 'Large Muscle Groups',
      cn: '大肌群舒展',
      jp: '大筋群集中ケア',
      kr: '대근육 집중 케어',
    },
    thumbnail: '/assets/images/treatments/bamboo-thumb.jpg',
    techniqueGallery: [
      '/assets/images/treatments/bamboo-1.jpg',
      '/assets/images/treatments/bamboo-2.jpg',
    ],
    intensity: 4,
    recommendedFor: {
      vi: 'Căng cơ đùi, mỏi bắp chân, đau mỏi thắt lưng hông, người đứng nhiều',
      en: 'Tight hamstrings, lower back strain, standing professionals',
      cn: '长期久站者、腿部紧绷水肿、腰臀肌肉深层劳损人群',
      jp: '立ち仕事で脚がパンパンな方、腰やお尻・太もものハリ',
      kr: '오래 서 있는 직업군, 허벅지·종아리 뭉침, 허리 골반 통증',
    },
  },
];
