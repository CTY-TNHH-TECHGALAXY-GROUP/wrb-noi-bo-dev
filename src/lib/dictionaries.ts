...
const dictionaries = {
    ...
    vi: {
        checkout: {
            ...
            payment_method_question: "Bạn dự định thanh toán bằng hình thức nào ?",
    ...
    kr: {
        checkout: {
            ...
            payment_method_question: "결제 방식을 선택해주세요.",
    ...
    cn: {
        checkout: {
            ...
            payment_method: "支付方式",
            payment_method_question: "您打算如何付款？",
    ...
    jp: {
        checkout: {
            ...
            payment_method_question: "どのお支払い方法をご希望ですか？",
