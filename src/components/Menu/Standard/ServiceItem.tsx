    ...
    if (singleOption) {
        return (
            ...
            >
                ...
                {isBestSeller && (
                    <div className="absolute left-5 top-5 z-20 rounded-full bg-red-600 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-white shadow-md sm:text-xs">
                        BEST SELLER
                    </div>
                )}
    ...
    return (
      ...
      `}
        >
            ...
            {isBestSeller && (
                <div className="absolute top-0 right-0 z-20 bg-red-600 text-white text-[11px] sm:text-xs font-bold px-2.5 sm:px-3 py-1 rounded-bl-lg shadow-md uppercase tracking-wider">
                    BEST SELLER
                </div>
            )}
