                                        ...
                                        <div className="wheel-node absolute left-0 top-0 w-0 h-0">
                                            ...
                                            <div className="absolute left-0 top-0 -translate-x-1/2 -translate-y-1/2">
                                                ...
                                                <motion.button
                                                    ...
                                                    whileHover={{ scale: 1.05, borderColor: '#d87d1f' }}
                                                    whileTap={{ scale: 0.95 }}
                                                    style={{ 
                                                    ...
                                                    className={`flex flex-col items-center justify-center gap-1 md:gap-2 px-1 py-2 ${TOKENS.cardBg} ${TOKENS.cardBorder} border hover:border-[#d87d1f] transition-colors relative overflow-hidden group shadow-lg`}
                                                >
                                                <div className="absolute inset-0 bg-gradient-to-br from-[#d87d1f]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                            ...
                                            >
                                                <img
                                                    ...
                                                    style={{
                                                        filter: 'brightness(0) invert(60%) sepia(100%) saturate(1000%) hue-rotate(-5deg) brightness(95%) contrast(100%) drop-shadow(0 2px 4px rgba(0,0,0,0.5))'
                                                    }}
                                                />
                                            </div>
                                            <span 
                                                style={{ fontSize: 'min(3.2vw, 3.2vh, 24px)' }}
                                                className="font-semibold tracking-wide text-center leading-tight relative z-10 w-full text-[#d87d1f] drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] group-hover:brightness-125 transition-all duration-300 px-2"
                                            >
                                                {name}
                                            </span>
                                        </motion.button>
