...
const TEXT: Record<string, Record<string, string>> = {
    ...
    kr: {
        title:          'VIP 장바구니',
        empty:          '아직 패키지가 없습니다',
        empty_sub:      '테라피스트를 선택하고 서비스를 구성하세요',
        add_another:    '직원 추가',
        checkout_btn:   '결제 진행',
        total:          '총액',
        close:          '닫기',
        ...
        edit:           '편집',
        delete:         '삭제',
        delete_confirm: '이 패키지를 삭제하시겠습니까?',
        delete_sub:     '이 작업은 취소할 수 없습니다',
        cancel:         '취소',
        pkg:            '패키지',
    },
    cn: {
    ...
    jp: {
        title:          'VIPカート',
        empty:          'パッケージがありません',
        empty_sub:      'セラピストを選択し、サービスを構成してください',
        add_another:    'スタッフを追加',
        checkout_btn:   'レジに進む',
        total:          '合計',
        close:          '閉じる',
        ...
        edit:           '編集',
        delete:         '削除',
        delete_confirm: 'このパッケージを削除しますか？',
        delete_sub:     'この操作は元に戻せません',
        cancel:         'キャンセル',
        pkg:            'パッケージ',
    },
};
            ...
            >
                ...
                <div className="p-5 bg-[#1c1c1e] border-t border-white/5 shrink-0">
                    ...
                    <div className="flex justify-between items-end mb-5">
                        <span className="text-[#C9D1DE] font-bold tracking-widest text-sm uppercase mb-1">{t.total}</span>
