...
export const DEEP_BODY_I18N = {
  ...
  select_technique_subtitle: {
    vi: 'Bạn có thể chọn nhiều hơn một liệu pháp để kết hợp',
    en: 'You can select more than one therapy',
    cn: '可选择多种理疗手法进行组合',
    jp: '複数のセラピーを選択して組み合わせることができます',
  ...
  mix_single_hint: {
    vi: 'Chọn 1 liệu pháp sẽ chuyển về chế độ liệu pháp đơn',
    en: 'Selecting 1 therapy will switch back to single therapy mode',
    cn: '选择1种手法将返回单项理疗模式',
    jp: '1種類の手技を選択すると単一コースに戻ります',
    kr: '1가지 기법을 선택하면 단일 테라피 모드로 전환됩니다',
  },
  duration_auto_adjusted: {
    vi: 'Thời lượng tối thiểu cho {count} phương pháp là {min} phút',
    en: 'Minimum duration for {count} methods is {min} mins',
    cn: '{count}种手法的最低时长为{min}分钟',
    jp: '{count}種類の手技には最低{min}分が必要です',
    kr: '{count}개 기법의 최소 이용 시간은 {min}분입니다',
  },
  intensity_label: {
    vi: 'Cường độ ấn sâu',
