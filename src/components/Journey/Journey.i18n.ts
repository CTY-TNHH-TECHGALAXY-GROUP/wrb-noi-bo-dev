...
export const translations: Record<string, any> = {
    vi: {
        ...
        fullCourse: 'Toàn bộ liệu trình',
        completedLabel: 'Hoàn tất',
        detailedRating: 'Đánh giá chi tiết',
        ratingError: 'Gửi đánh giá thất bại. Vui lòng thử lại.',
    ...
    kr: {
        ...
        ratingError: '평가 제출에 실패했습니다. 다시 시도해 주세요.',
        // Check belongings
    ...
    jp: {
        ...
        completedLabel: '完了',
        detailedRating: '詳細評価',
        ratingError: '評価の送信に失敗しました。もう一度お試しください。',
        // Check belongings
