...
const TEXT: Record<string, Record<string, string>> = {
    ...
    kr: {
        ...
        mins: '분',
        notes: '📝 특별 요청사항',
        notes_placeholder: '알레르기, 부상, 특별 요청...',
        price_label: '서비스 가격',
        cancel: '취소',
        save: '변경사항 저장',
        loading: '스킬 불러오는 중...',
        min_duration_hint: '이 선택에 대한 최소 시간:',
        no_chinh: '최소 1개의 메인 서비스를 선택해주세요',
    },
    cn: {
        title: '编辑VIP服务',
        ktv: '负责理疗师',
        ...
        mins: '分钟',
        notes: '📝 特殊备注',
        notes_placeholder: '过敏、受伤、特殊要求...',
        price_label: '服务价格',
        cancel: '取消',
        save: '保存更改',
        loading: '正在加载技能...',
        min_duration_hint: '此选项的最少时长：',
        no_chinh: '请至少选择1个主要服务',
    },
    jp: {
        title: 'VIPサービスの編集',
        ktv: '担当セラピスト',
        skills_chinh: '💪 メインサービス',
        skills_le: '✨ 追加サービス',
        duration: '⏱ 時間',
        mins: '分',
        notes: '📝 特別なご要望',
        notes_placeholder: 'アレルギー、怪我、特別なご要望...',
        price_label: 'サービス料金',
        cancel: 'キャンセル',
        save: '変更を保存',
        loading: 'スキルを読み込み中...',
        min_duration_hint: 'この選択の最小時間：',
        no_chinh: '少なくとも1つのメインサービスを選択してください',
    },
};
