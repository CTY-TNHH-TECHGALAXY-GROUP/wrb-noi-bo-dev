                                                    ...
                                                    {vipSkillIds.map((skillId: string) => {
                                                        ...
                                                        return (
                                                            <span key={skillId} className={`text-[10px] px-2 py-0.5 rounded-full border font-medium bg-transparent ${
                                                                isChinhSkill
                                                                    ? 'text-[#e6c487] border-[#e6c487]/30'
                                                                    : 'text-[#d0c5b5] border-white/10'
                                                            }`}>
                                                                {name}
                                                            </span>
                                                        );
                                            ...
                                            {(item.options.notes.tag0 || item.options.notes.tag1 || item.options.notes.privateRoom) && (
                                                <div className="flex justify-end gap-2">
                                                    {item.options.notes.tag0 && (
                                                        <span className="bg-transparent text-[#C9A96E] text-[10px] px-2 py-1 rounded border border-[#C9A96E]/30 font-bold uppercase">
                                                            {item.TAGS?.[0] ? (item.TAGS[0][lang as keyof typeof item.TAGS[0]] || item.TAGS[0].vi || item.TAGS[0].vn || item.TAGS[0].en) : (dict.tags?.pregnant || 'Pregnant')}
                                                        </span>
                                                    )}
                                                    ...
                                                    {item.options.notes.privateRoom && (
                                                        <span className="bg-transparent text-[#F2C96B] text-[10px] px-2 py-1 rounded border border-[#C9A96E]/30 font-bold uppercase">
