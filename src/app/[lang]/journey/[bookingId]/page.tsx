                ...
                {state === 'DONE' && (
                    <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in zoom-in-95">
                        ...
                        <div className="flex flex-col gap-3 mt-8">
                            <button onClick={() => window.location.href = `/${lang}/standard/menu`} className="px-8 py-3 bg-[#C9A96E] border-none rounded-2xl font-bold text-black uppercase tracking-widest shadow-lg hover:bg-[#b09461] transition-colors">{t.goHome}</button>
