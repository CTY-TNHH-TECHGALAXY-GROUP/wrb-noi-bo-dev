...
export default function CheckoutPage({ params }: { params: Promise<{ lang: string; menuType: string }> }) {
    ...
    const handleBack = () => {
        ...
        router.replace(`/${activeLang}/old-user/${menuType}/menu`);
    };
    ...
    return (
        <div className="min-h-screen bg-[#0d0d0d] text-white pb-32 font-sans animate-in fade-in duration-500">
            ...
            <div className="fixed bottom-0 left-0 w-full bg-[#1c1c1e] p-4 border-t border-white/10 z-40 shadow-[0_-5px_20px_rgba(0,0,0,0.5)] xl:hidden">
